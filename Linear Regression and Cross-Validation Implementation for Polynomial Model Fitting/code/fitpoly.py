...
def exercise_1(data_path, figure_path):
    #### YOUR CODE HERE ####
    w = read_data_fit_plot(data_path, 1, "Women's 100 meter dash data", save_path=figure_path) # Calculate w vector (as an numpy.array)
...
def exercise_2(data_path, figure_path):
    #### YOUR CODE HERE ####
    w = read_data_fit_plot(data_path, 3, "synthdata", save_path=figure_path)  # Calculate w vector (as an numpy.array)
